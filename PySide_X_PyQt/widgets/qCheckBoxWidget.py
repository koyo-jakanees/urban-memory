...
from PyQt5.QtWidgets import QApplication, QCheckBox, QLabel, QWidget
...
class CheckBoxWindow(QWidget):
    ...
    def displayCheckBoxes(self):
        """sets up the checkboxs and other widgets."""
        ...
        morning_cb.toggle()  # commnent if you don't want box to start off checked
        morning_cb.stateChanged.connect(self.printToTerminal)

        after_cb = QCheckBox("Afternoon [1PM - 3AM]", self)  # text, parent
